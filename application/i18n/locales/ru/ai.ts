...
export const ruAiMessages: Messages = {
  ...
  'ai.codebuddy.description': 'Использует CodeBuddy Code через ACP (`codebuddy --acp`). После обнаружения может быть выбран как внешний агент для программирования.',
  ...
  'ai.codebuddy.envVars.placeholder': 'CODEBUDDY_AUTH_TOKEN=...\nCODEBUDDY_MODEL=...\nOTHER_VAR=...',
  'ai.codebuddy.envVars.hint': 'По одной записи KEY=VALUE на строку, передаются агенту CodeBuddy. Укажите CODEBUDDY_AUTH_TOKEN для аутентификации. Хранятся локально в открытом виде.',
