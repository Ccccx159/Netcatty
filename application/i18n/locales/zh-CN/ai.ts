...
export const zhCNAiMessages: Messages = {
  ...
  'ai.codebuddy.description': '通过 ACP（`codebuddy --acp`）接入 CodeBuddy Code。检测到后即可作为外部编程 Agent 使用。',
  ...
  'ai.codebuddy.envVars.hint': '每行一个 KEY=VALUE，传给 CodeBuddy agent。可在此设置 CODEBUDDY_AUTH_TOKEN 完成认证。明文存在本地。',
