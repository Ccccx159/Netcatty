...
export const enAiMessages: Messages = {
  ...
  'ai.codebuddy.description': 'Uses CodeBuddy Code via ACP (`codebuddy --acp`). Once detected, it can be selected as an external coding agent.',
  ...
  'ai.codebuddy.envVars.hint': 'One KEY=VALUE per line, passed to the CodeBuddy agent. Set CODEBUDDY_AUTH_TOKEN here for authentication. Stored locally in plaintext.',
